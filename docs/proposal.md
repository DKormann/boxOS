...
Users are implicit accounts controlled by unguessable bearer credentials. Functions receive a stable hash-derived caller ID, never the credential itself.
